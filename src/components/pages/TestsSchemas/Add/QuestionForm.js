...
class QuestionForm extends PureComponent {
    ...
    this.setState(state => {
      ...
      return {
        ...
        errors: {
          ...state.errors,
          [`option-${index}`]:
            name === "content" ? "" : state.errors[`option-${index}`], // Reseting the error if User is editing option content
        },
      };
    });
  };
  ...
  addOption = () => {
    this.setState(state => ({
      options: [...state.options, { content: "", correct: false }],
    }));
  };
      ...
      <Modal isOpen={isOpen} title={t("testsSchemas.addQuestion")}>
        <Modal.Content>
          ...
          >
                    ...
                    return (
                      <tr>
                        ...
                        <td>
                          <Button.Group
                            align="center"
                            className="new-question-form__remove-btn"
                          >
                            <Button
                              variant="icon"
                              icon="trash-alt"
            ...
            <Button type="button" variant="text" onClick={this.addOption}>
              {t("testsSchemas.addAnswer")}
            </Button>
