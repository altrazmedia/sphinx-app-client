...
class TestsSchemas extends PureComponent {
  ...
  render = () => {
    ...
    return (
      <Switch>
        <Route path={path} exact render={props => <List subjectSelected={subject} changeSubject={this.changeSubject} {...props} /> } />
        <Route path={`${path}/add`} exact render={props => <Add defaultSubject={subject} {...props} /> } />
...
export default connect(READ, EMIT)(TestsSchemas);