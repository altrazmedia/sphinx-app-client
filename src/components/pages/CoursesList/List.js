  ...
  return (
    <div className="segment">
      <table className="table">
        <thead>
          <tr>
            {(displayAll || displayedData.includes("code")) && (
              <th>
                <Trans i18nKey="code" />
              </th>
            )}
            {(displayAll || displayedData.includes("subject")) && (
              <th>
            ...
            {(displayAll || displayedData.includes("teacher")) && (
              <th>
                <Trans i18nKey="users.teacher" />
              </th>
            )}
...
CoursesListTable.propTypes = {
  ...
  displayedData: PropTypes.arrayOf(
    PropTypes.oneOf(["code", "subject", "group", "teacher", "details", "all"])
  ),
};
