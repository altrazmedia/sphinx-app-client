...
class AddTestSchema extends PureComponent {
  ...
  saveTestSchema = testSchema => {
    axios
      ...
      .catch(err => {
        this.setState({
          errorMsg: `${this.props.t("operationError")} (${
            err.response.status
          })`,
        });
      });
          ...
          <div className="segment">
            ...
            {questions.map((question, index) => {
              return (
                <Question
                  question={question}
                  remove={this.removeQuestion(index)}
                />
              );
            })}
            ...
            <Button.Group align="right">
              <Button
                variant="text"
                onClick={this.openNewQuestionForm}
                type="button"
                icon="plus"
              >
                {t("testsSchemas.addQuestion")}
              </Button>
            </Button.Group>
