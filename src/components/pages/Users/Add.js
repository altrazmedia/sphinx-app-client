...
class AddUser extends PureComponent {
  ...
  render = () => {
    ...
    const { label, email, role, password, passwordConfirm, errors, errorMsg } = this.state;
    const { t, close } = this.props;
    ...
    return (
      ...
      >
        ...
        <Modal.Buttons>
          <Button variant="text" onClick={close} type="button">{t("cancel")}</Button>
...
export default connect(null, EMIT)(withTranslation()(AddUser));
